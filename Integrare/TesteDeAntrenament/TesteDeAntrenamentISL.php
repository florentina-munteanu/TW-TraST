...
<div id="NavBar">
    <nav class="navbar" id="navi">
      ...
      <div class="right">
      <a href="../PaginaPrincipala/Acasa.php">Heimilið</a>
  ...
  <div id="side-menu" class="side-nav">
    ...
    <a href="../TesteDeAntrenament/TesteDeAntrenament.php">Þjálfunarpróf</a>
  ...
  class Actiune
  {
    ...
    {
      $sql = "SELECT Intrebare FROM intrebarii WHERE Id=:Id";
    ...
    {
      $sql = "SELECT R1,R2,R3,Correct FROM raspunsi WHERE Id=:Id";
      $cerere = BD::obtine_conexiune()->prepare($sql);
      $cerere->execute([
        'Id' => $id
      ]);
  ...
  <div class=\"display\">
    ...
    <div class=\"miniCard\">
      ...
      <p>Rétt svör:$corect</p>
      </div>
      <div class=\"raspGresite\">
      <p>Röng svör:$gresit</p>
      </div>
      </div>
    </div>
    <div class=\"card\">
      ...
      <form action=\"./TesteDeAntrenamentISL.php\" method=\"post\">
    ...
    <input type=\"hidden\" name = \"test\" value=\"$test\">
      ...
      echo "<form action=\"./TesteDeAntrenamentISL.php\" method=\"post\">
    <div class=\"wrapper\">
      <div class=\"display\">
        <h1>Þjálfunarpróf</h1>
        <div class=\"card\">
    ...
    <div class=\"wrapper\">
      <div class=\"display\">
        ...
        <div class=\"card\">
          <div class=\"text\"
            <h2>Til hamingju, þú ert búinn!</h2>
          </div>
          <button>Næsta próf</button>
        </div>
      </div>
